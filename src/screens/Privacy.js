        ...
        <div className="bg-white my-12">
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                At EcommerSio Market, accessible from EcommerSio Market dot com,
                one of our main priorities is the privacy of our visitors. This
                Privacy Policy document contains types of information that is
                collected and recorded by EcommerSio Market and how we use it.
                If you have additional questions or require more information
                about our Privacy Policy, do not hesitate to contact us.we may
              ...
              <p>
                ...
                information that they shared and/or collect in EcommerSio
                Market.we may receive additional information about you such as
                your name, email address, phone number, the contents of the
                message and/or attachments you may send us, we may ask for your
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                EcommerSio Market follows a standard procedure of using log
                files. These files log visitors when they visit websites. All
                hosting companies do this and a part of hosting. The information
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                ...
                the advertising partners of EcommerSio Market. Third-party ad
                servers or ad networks uses technologies like cookies,
                JavaScript, or Web Beacons that are used in their respective
                advertisements and links that appear on EcommerSio Market, which
                ...
                that you visit. Note that EcommerSio Market has no access to or
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                ...
                respective advertisements and links that appear on EcommerSio
                Market, which are sent directly to users' browser. They
                ...
                EcommerSio Market has no access to or control over these cookies
                that are used by third-party advertisers.
              </p>
              <p>
                EcommerSio Market's Privacy Policy does not apply to other
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              ...
              <p>
                EcommerSio Market does not knowingly collect any Personal
