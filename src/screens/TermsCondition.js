        ...
        <div className="bg-white my-12">
          <div className="mb-8 lg:mb-12 last:mb-0">
            <h2 className="text-xl xl:text-2xl xl:leading-7 font-semibold mb-2 lg:mb-4">
              Welcome to EcommerSio Market!
            </h2>
            <div className="font-sans leading-7">
              <p>
                These terms and conditions outline the rules and regulations for
                the use of EcommerSio Market's Website. By accessing this
                website we assume you accept these terms and conditions. Do not
                continue to use EcommerSio Market if you do not agree to take
          ...
          <div className="mb-6 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                We employ the use of cookies. By accessing EcommerSio Market,
                you agreed to use cookies in agreement with the EcommerSio
          ...
          <div className="mb-8 lg:mb-12 last:mb-0">
            ...
            <div className="font-sans leading-7">
              <p>
                Unless otherwise stated, EcommerSio Market and/or its licensors
                own the intellectual property rights for all material on
                EcommerSio Market. All intellectual property rights are
                reserved. You may access this from EcommerSio Market for your
              ...
              <p>
                ...
                website. EcommerSio Market does not filter, edit, publish or
                review Comments prior to their presence on the website. Comments
                do not reflect the views and opinions of EcommerSio Market,its
                agents and/or affiliates. Comments reflect the views and
                opinions of the person who post their views and opinions. To the
                extent permitted by applicable laws, EcommerSio Market shall not
